...
class Mirai(metaclass=Singleton):
    ...
    def __init__(self,
                 ...
                 adapter: str = 'http', host: str = "localhost"):
        """创建一个 Mirai 对象
    ...
    def __http_run(self):
        ...
        if not self.session_key:
            ...
            if all(
                ...
                logging.info(f"sessionKey: {verify_response['session']}")
    ...
    def __ws_run(self):
        ...
        if all(
            ...
            logging.info(f"sessionKey: {connect_data['session']}")
        else:
            ...
            try:
                ...
                if msg_json['syncId'] == '-1':
                    ...
                    if sync_id in self.__msg_pool:
                        ...
                        logging.error('Exception: 没有找到对应的 sync_id')
            except:
                pass
    ...
    def send_friend_msg(self, qq: int, msg):
        ...
        # logging.send_message(f"bot_msg")
        return response
